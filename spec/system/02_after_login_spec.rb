  ...
  describe "ヘッダーのテスト: ログインしている場合" do
    context "リンクの内容を確認: ※logoutは『ユーザログアウトのテスト』でテスト済みになります。" do
      ...
      it "社員のドロップダウンで社員登録を押すと、社員登録画面に遷移する" do
        ...
        companies_link = companies_link.delete("\n").gsub(/\A\s*/, "").gsub(/\s*\Z/, "")
      ...
      it "サービスのドロップダウンで店舗管理を押すと、店舗管理画面へ遷移する" do
        ...
        stores_link = stores_link.delete("\n").gsub(/\A\s*/, "").gsub(/\s*\Z/, "")
      ...
      it "サービスのドロップダウンで車両管理を押すと、車両管理画面へ遷移する" do
        ...
        car_names_link = car_names_link.delete("\n").gsub(/\A\s*/, "").gsub(/\s*\Z/, "")
      ...
      it "サービスのドロップダウンでジャンル管理を押すと、ジャンル管理画面へ遷移する" do
        ...
        genres_link = genres_link.delete("\n").gsub(/\A\s*/, "").gsub(/\s*\Z/, "")
